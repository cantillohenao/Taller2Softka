...
/**
 * class implementation extending from the abstract class spacecraft
 */
...
public class UnmannedShips extends Spaceships{
     ...
     */
    public UnmannedShips(String type, String name, long speed, float height, float weight, String typeFuel) {
